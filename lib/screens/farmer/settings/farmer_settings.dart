    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildAccountInfoItem('Nama', _userName, isDarkMode),
                ...
                child: Column(
                  children: [
                    ...
                    _buildSettingItem(
                      ...
                      subtitleColor: isDarkMode ? Colors.grey.shade400 : null,
                      trailing: Switch(
                    ...
                    _buildSettingItem(
                      ...
                      trailing: Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            fontSize: 12,
                            color: isDarkMode ? _primaryColor : _primaryColor,
                            fontWeight: FontWeight.bold,
                          ),
                        ),
                      ),
  ...
  Widget _buildSettingItem({
    ...
    return ListTile(
      ...
      subtitle: Text(
        ...
        style: TextStyle(
          fontSize: 13,
          color: subtitleColor ?? (isDarkMode ? Colors.grey.shade400 : Colors.grey.shade600),
        ),
      ),
      trailing: trailing,
      onTap: onTap,
